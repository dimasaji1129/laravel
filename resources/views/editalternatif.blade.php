...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <!-- left column --><td>{{ $alternatif->warna }}</td>
          <div class="col-md-12">
            <!-- Horizontal Form -->
              ...
              <form method="POST" action="{{ url('/alternatif/update/'.$alternatif->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="ukuran" placeholder="Nilai Kriteria (ukuran)" value="{{ $alternatif->ukuran}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="merek" class="col-sm-2 col-form-label">C3</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="merek" placeholder="Nilai Kriteria (merek)" value="{{ $alternatif->merek}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="warna" class="col-sm-2 col-form-label">C4</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="warna" placeholder="Nilai Kriteria (warna)" value="{{ $alternatif->warna}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="jenis" class="col-sm-2 col-form-label">C5</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="jenis" placeholder="Nilai Kriteria (jenis)" value="{{ $alternatif->jenis}}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
